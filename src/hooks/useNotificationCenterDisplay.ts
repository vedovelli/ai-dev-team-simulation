...
/**
 * Configuration options for useNotificationCenterDisplay hook
 */
export interface UseNotificationCenterDisplayOptions {
...
/**
 * Notification Center Display Hook with Performance Optimizations
 *
 ...
 */
export function useNotificationCenterDisplay(
  options: UseNotificationCenterDisplayOptions = {}
) {
  const {
...
export type UseNotificationCenterDisplayReturn = ReturnType<typeof useNotificationCenterDisplay>
