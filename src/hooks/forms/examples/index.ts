/**
 * Form example implementations
 *
 * Demonstrates practical usage of custom form hooks:
 * - LoginFormExample: TanStack Form with email/password validation (simple form)
